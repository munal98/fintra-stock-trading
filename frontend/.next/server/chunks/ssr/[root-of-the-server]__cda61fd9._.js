...
"[project]/configs/authConfig.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$configs$2f$authConfig$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/configs/authConfig.ts [app-ssr] (ecmascript)");
...
function LoginForm({ className, ...props }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        if (email.length < 8 || password.length < 8) {
            ...
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(__TURBOPACK__imported__module__$5b$project$5d2f$configs$2f$authConfig$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].loginEndpoint, {
                    email,
                    password
                });
                const { token, email: userEmail, role, firstName, lastName } = response.data;
                localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$configs$2f$authConfig$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].storageTokenKeyName, token);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cda61fd9._.js.map