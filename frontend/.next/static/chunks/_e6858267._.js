...
"[project]/app/home-page/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function HomePage() {
    ...
    const [stockDefinitions, setStockDefinitions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [selectedAssetCode, setSelectedAssetCode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const [stockTableLoading, setStockTableLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [stockPagination, setStockPagination] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        pageIndex: 0,
        pageSize: 5
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const fetchStockDefinitonsData = async ()=>{
        ...
        try {
            ...
            setError(((_err_response = err.response) === null || _err_response === void 0 ? void 0 : (_err_response_data = _err_response.data) === null || _err_response_data === void 0 ? void 0 : _err_response_data.message) || "Fetch Get Stock Definitions Catch Error : ".concat((_err_response1 = err.response) === null || _err_response1 === void 0 ? void 0 : (_err_response_data1 = _err_response1.data) === null || _err_response_data1 === void 0 ? void 0 : _err_response_data1.message));
            console.error(err);
        } finally{
            setLoading(false);
            setStockTableLoading(false);
    ...
    const handleShowDetails = async (ticker)=>{
        ...
        try {
            const response = await sendRequest.get("/equities/".concat(ticker, "/prices"));
    ...
    const equityColumns = [
        ...
        },
        {
            ...
            cell: (param)=>{
                let { row } = param;
                return row.original.equityName;
            }
        },
        {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: chartLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    title: "".concat(selectedAssetCode, " Price History"),
                                                    data: priceData
                                                }, void 0, false, {
                                                    fileName: "[project]/app/home-page/page.tsx",
                                                    lineNumber: 170,
                                                    columnNumber: 41
                                                }, this) : selectedAssetCode && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(HomePage, "/6uJZGyM9S+bcdCnJCUMiYrvSAA=");
_c = HomePage;
var _c;
...
//# sourceMappingURL=_e6858267._.js.map