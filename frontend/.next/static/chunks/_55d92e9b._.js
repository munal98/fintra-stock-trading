...
function OrderHistory() {
    ...
    const fetchOrderHistoryDetail = async (orderId)=>{
        setEditLoading(true);
        try {
            const response = await sendRequest.get("/equity-order/".concat(orderId));
    ...
    const handleDeleteOrder = async (order)=>{
        try {
            setLoading(true);
            await sendRequest.delete("/equity-order/".concat(order.orderId));
    ...
    const handleSaveEdit = async ()=>{
        ...
        try {
            setLoading(true);
            await sendRequest.patch("/equity-order/".concat(editingOrder.orderId), editFormData);
            setTimeout(()=>fetchOrderHistory(), 3000);
            setOrders((prevOrders)=>prevOrders.map((order)=>order.orderId === editingOrder.orderId ? {
                        ...order,
                        ...editFormData
                    } : order));
    ...
    const applyFilters = ()=>{
        ...
        if (searchQuery) {
            filtered = filtered.filter((order)=>order.firstName.toString().toLowerCase().includes(searchQuery.toLowerCase()) || order.lastName.toString().toLowerCase().includes(searchQuery.toLowerCase()));
        }
    ...
    const columns = [
        ...
        },
        {
            ...
            cell: (param)=>{
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    className: "text-sm",
                    children: "".concat(row.original.firstName, " ").concat(row.original.lastName)
                }, void 0, false, {
                    fileName: "[project]/app/buy-sell/order-history/page.tsx",
                    lineNumber: 273,
                    columnNumber: 9
        ...
        },
        {
            ...
            cell: (param)=>{
                let { row } = param;
                var _row_original_oldOrderQuantity;
                return (_row_original_oldOrderQuantity = row.original.oldOrderQuantity) === null || _row_original_oldOrderQuantity === void 0 ? void 0 : _row_original_oldOrderQuantity.toLocaleString();
            }
        },
        {
        ...
        },
        {
            ...
            cell: (param)=>{
                let { row } = param;
                var _this;
                return "₺".concat((_this = row.original.oldOrderQuantity * row.original.oldPrice) === null || _this === void 0 ? void 0 : _this.toFixed(2));
            }
        },
        {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        ...
                                        className: "flex items-center gap-2 justify-start h-8 px-2 ".concat(orderType === "MARKET" ? "opacity-50 cursor-not-allowed" : ""),
                                        ...
                                        children: [
                                            ...
                                            t("Edit"),
                                            orderType === "MARKET" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                                                children: t("Filter and search order history")
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/buy-sell/order-history/page.tsx",
                                                                lineNumber: 458,
                                                                columnNumber: 21
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                                                children: t("Showing ".concat(filteredOrders.length, " orders"))
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/buy-sell/order-history/page.tsx",
                                                                lineNumber: 544,
                                                                columnNumber: 21
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogHeader"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogDescription"], {
                                    children: editingOrder && "".concat(t("Order ID"), ": #").concat(editingOrder.orderId)
                                }, void 0, false, {
                                    fileName: "[project]/app/buy-sell/order-history/page.tsx",
                                    lineNumber: 568,
                                    columnNumber: 13
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogFooter"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                    ...
                                    disabled: editLoading,
                                    children: editLoading ? t("Saving...") : t("Save Changes")
                                }, void 0, false, {
                                    fileName: "[project]/app/buy-sell/order-history/page.tsx",
                                    lineNumber: 628,
                                    columnNumber: 13
...
_s(OrderHistory, "AFpXnIhiW+GmNGRpRgeW9/358q0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$i18next$2f$dist$2f$es$2f$useTranslation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslation"]
    ];
});
...
//# sourceMappingURL=_55d92e9b._.js.map