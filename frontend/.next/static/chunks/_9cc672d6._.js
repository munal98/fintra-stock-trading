...
function OrderHistory() {
    ...
    const applyFilters = ()=>{
        ...
        if (searchQuery) {
            filtered = filtered.filter((order)=>order.firstName.toString().includes(searchQuery.toLowerCase()) || order.lastName.toString().includes(searchQuery.toLowerCase()));
        }
...
_s(OrderHistory, "8ZMENvUPXP85Rd9rXVxHR8rVaQI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$i18next$2f$dist$2f$es$2f$useTranslation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslation"]
    ];
});
...
//# sourceMappingURL=_9cc672d6._.js.map