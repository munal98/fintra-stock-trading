...
function AuthProvider(param) {
            ...
            const checkAuth = {
                "AuthProvider.useEffect.checkAuth": ()=>{
                    ...
                    const checkRouteAccess = {
                        "AuthProvider.useEffect.checkAuth.checkRouteAccess": ()=>{
                            if (!role) {
                                router.push('/login');
                                return false;
                            }
                            ...
                            const hasAccess = allowedRoutes.some({
                                "AuthProvider.useEffect.checkAuth.checkRouteAccess.hasAccess": (route)=>pathname === route || pathname.startsWith("".concat(route, "/"))
                            }["AuthProvider.useEffect.checkAuth.checkRouteAccess.hasAccess"]);
                            if (!hasAccess) {
    ...
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$loading$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LoadingOverlay"], {}, void 0, false, {
...
_s(AuthProvider, "HHoXq7W5RND/t495Jqhr5qNmB5M=", false, function() {
    return [
...
//# sourceMappingURL=_67b08fb0._.js.map